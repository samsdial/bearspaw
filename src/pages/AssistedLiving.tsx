...
const features = [
  {
    ...
    description: "Individual care plans that adapt to each resident's changing needs while preserving independence.",
  },
  {
    icon: Pill,
    title: 'Medication Management',
    description: 'Professional medication administration and oversight with personalized follow-up and physician coordination.',
  },
  {
    icon: Utensils,
    title: 'Gourmet Dining',
    description: 'Chef-prepared menus with personalized nutrition options, served in an elegant communal dining room.',
  },
  {
    icon: Shirt,
    title: 'Laundry and Housekeeping',
    description: 'Comprehensive laundry and housekeeping services so residents can focus on enjoying their day.',
  },
  {
    icon: Accessibility,
    title: 'Mobility and Transportation',
    description: 'Mobility assistance, escort support for medical appointments, and scheduled transportation for community outings.',
  },
  {
    icon: Home,
    title: 'Private Suites',
    description: 'Spacious, bright suites with adapted private bathrooms designed to feel like home.',
  },
];
          ...
          <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
              ...
              <p className="body-lg mb-8">
                Our Assisted Living program offers the ideal balance of personal independence and professional support, allowing each resident to live with dignity and comfort.
              </p>
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.7, delay: 0.2 }} className="relative rounded-[20px] overflow-hidden shadow-elevated">
              <img src={commonRoom} alt="Assisted Living lounge at Bearspaw" className="w-full h-[400px] lg:h-[500px] object-cover" />
      ...
      <section className="section-padding">
        <div className="container-wide">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="body-lg">Comprehensive services designed to make life more comfortable, safe, and enjoyable.</p>
          </motion.div>
        ...
        <div className="container-wide">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <motion.div initial={{ opacity: 0, x: -30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }}>
              <h2 className="heading-lg mb-6">A Day in <span className="text-primary">Assisted Living</span></h2>
              <p className="body-md mb-6">Each day is filled with opportunities to enjoy, connect, and live with purpose.</p>
            ...
            <motion.div initial={{ opacity: 0, x: 30 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="rounded-[20px] overflow-hidden shadow-card">
              <img src={wellnessRoom} alt="Activities in Assisted Living" className="w-full h-[400px] object-cover" />
            </motion.div>
          </div>
        </div>
      </section>
      ...
      <section className="section-padding">
        <div className="container-narrow">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center">
            <h2 className="heading-lg mb-6">Ready to <span className="text-primary">Meet Us</span>?</h2>
            <p className="body-lg mb-10">Schedule a personalized visit and discover why families trust Bearspaw with the care of their loved ones.</p>
