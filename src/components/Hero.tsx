        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          >
            ...
            <p className="body-lg max-w-lg">
              ...
              Experience a community designed for comfort, connection, 
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4">
              ...
              <a href="#philosophy" className="btn-outline inline-flex items-center justify-center">
            ...
            <div className="grid grid-cols-3 gap-6 pt-8 border-t border-border">
              <div>
                ...
                <p className="font-sans text-sm text-muted-foreground mt-1">Years of Excellence</p>
              </div>
              <div>
                <p className="font-serif text-3xl font-semibold text-primary">98%</p>
                <p className="font-sans text-sm text-muted-foreground mt-1">Family Satisfaction</p>
              </div>
              <div>
                <p className="font-serif text-3xl font-semibold text-primary">24/7</p>
                <p className="font-sans text-sm text-muted-foreground mt-1">Professional Care</p>
              </div>
            </div>
          </motion.div>
